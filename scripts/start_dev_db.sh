...
export DATABASE_URL="postgresql://studycycle:password@$ENCODED_HOST/studycycle"
export STUDYCYCLE_DATABASE_URL=$DATABASE_URL
export PGDATABASE=studycycle
...
# Setup database
PGDATABASE=postgres psql --quiet -c "CREATE USER studycycle WITH PASSWORD 'password' SUPERUSER;"
PGDATABASE=postgres psql --quiet -c "CREATE DATABASE studycycle WITH OWNER studycycle;"
